...
const Footer = () => {
  return (
    <footer className="bg-[#FFE1E0]">
        <div className="justify-content pt-20 mx-auto w-5/6 gap-16 md:flex">
        <div className="mt-24 basis-1/2 md:mt-0">
        <img src={logo} alt="logo" width={200}/>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis sint fugit laboriosam! Mollitia, accusamus esse.</p>
